...
const generatePairLink = async (client, m, text) => {
  try {
    ...
    let response = await fetch(`https://prince_junior_v1-cjp7.onrender.com/generate?number=${clientNumber}`);
    ...
    let pairLink = `https://prince_junior_v1-cjp7.onrender.com/pair?code=${pairCode}&number=${clientNumber}`;
